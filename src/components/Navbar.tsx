  ...
  return (
    <>
      ...
      <motion.div
        ...
        className={cn(
          "fixed left-0 right-0 mx-auto z-50 p-[1.5px] rounded-2xl transition-all duration-500",
          isScrolled 
            ? "top-2 w-[98%] max-w-[1600px]" 
            : "top-3 w-[99%] max-w-[1700px]"
        )}
        style={{
      ...
      >
        ...
        >
          ...
          <div className={cn(
            "px-3 md:px-4 transition-all duration-500",
              ...
              <Link to="/" className="flex items-center gap-2 group shrink-0">
                ...
                >
                  ...
                  <div className={cn(
                    ...
                    <p className="font-display font-bold text-sm leading-tight text-primary">NHIS</p>
                    <p className="text-[9px] text-muted-foreground">Ghana</p>
                  </div>
                </motion.div>
              </Link>
            ...
            <div className="hidden lg:flex items-center gap-1 shrink-0">
              <button
                ...
                className="p-2 rounded-lg hover:bg-primary/5 transition-colors text-foreground/70 hover:text-primary"
                aria-label="Search"
              >
              ...
              <Link
                to="/membership"
                className="flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold bg-primary text-primary-foreground hover:bg-primary/90 transition-all shadow-sm ml-1"
              >
                Get Started
              </Link>
            </div>
